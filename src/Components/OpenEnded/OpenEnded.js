            ...
            <div className="card-box">
                ...
                <div className="" role="group" aria-label="Basic outlined example">
                    ...
                    <div className="input-box">
                        ...
                        className="form-control" value={data.ans} onChange={(e)=>onFieldUpdate("ANSWER",e.target.value)}></input> }
                        {data.ansType==='Long' && <textarea rows="3" 
                        className="form-control" value={data.ans} onChange={(e)=>("ANSWER",e.target.value)}></textarea> }   
                    </div>
                </div>
            </div>
        </div>
